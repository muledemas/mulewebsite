      ...
      <div className="w-full md:w-[50%] mt-6">
        ...
        <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6">
          <p className="flex items-center">
            ...
            <span className="text-red-600 hover:text-red-700 transition ease-in-out duration-200 cursor-pointer ml-2">
              Edit
            </span>
          </p>
          <p className="text-blue-600 hover:text-blue-700 transition ease-in-out cursor-pointer">
            Sign out
          </p>
        </div>
      </div>
